            ...
            <div class="pb-0 mb-3 card-header">
              <div class="flex-row d-flex justify-content-between">
                ...
                <a href="#" class="mb-0 btn bg-gradient-danger btn-sm" type="button" data-bs-toggle="modal"
                  data-bs-target="#modalAdd"><i class="fas fa-plus"></i>&nbsp; Tambah Mobil</a>
              </div>
            </div>
                  ...
                  <table id="DTFetch" class="table mb-0 align-items-center">
                    <thead>
                      <tr>
                        ...
                        <th class="text-xs text-center text-uppercase text-secondary font-weight-bolder opacity-7">Tarif
                        </th>
...
@section('modal')
  ...
  <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="modalAddTitle" aria-hidden="true">
    <form action="{{ route('mobil.store') }}" method="POST" class="formSave needs-validation"
      enctype="multipart/form-data">
      @csrf
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAddLabel">Mobil Baru</h5>
