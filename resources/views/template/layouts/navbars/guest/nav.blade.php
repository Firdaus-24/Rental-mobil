<!-- Navbar -->
<nav
  class="navbar navbar-expand-lg position-absolute z-index-3 {{ Request::is('static-sign-up') ? 'w-100 shadow-none  navbar-transparent mt-4' : 'blur blur-rounded shadow py-2 start-0 end-0 mx4' }} top-0 my-3">
  <div class="container-fluid {{ Request::is('static-sign-up') ? 'container' : 'container-fluid' }}">
    ...
    <button class="navbar-toggler ms-2 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#navigation"
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          <a href="https://www.creative-tim.com/product/soft-ui-dashboard-laravel" target="_blank"
            class="btn btn-sm btn-round me-1 bg-gradient-{{ Request::is('static-sign-up') ? 'light' : 'dark' }} mb-0">Free
            download</a>
        </li>
      </ul>
    </div>
