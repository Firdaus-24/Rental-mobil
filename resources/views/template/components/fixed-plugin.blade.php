  ...
  <div class="card shadow-lg">
    ...
    <div class="card-body pt-sm-3 pt-0">
      ...
      <a href="javascript:void(0)" class="switch-trigger background-color">
        <div class="badge-colors {{ Request::is('rtl') ? 'text-end' : 'text-start' }} my-2">
      ...
      <div class="d-flex">
        ...
        <button class="btn bg-gradient-primary w-100 {{ Request::is('rtl') ? 'me-2' : 'ms-2' }} mb-2 px-3"
      ...
      <div class="form-check form-switch ps-0">
        <input class="form-check-input ms-auto {{ Request::is('rtl') ? 'float-end' : '' }} mt-1"" type="checkbox"
